...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '.valueReportCopy {',
    ...
    'top: 3px;',
    'right: -17px;',
    'background: $colour_valueReportBackground;',
    'border: 1px solid $colour_valueReportBorder;',
    'border-left: none;',
    'border-radius: 0 4px 4px 0;',
  '}',
  '.errorReportBox + .valueReportCopy {',
    'background: $colour_errorReportBackground;',
    'border-color: $colour_errorReportBorder;',
  '}',
  ...
  */
  ...
  '.blocklyDropDownDiv .goog-menuseparator {',
    'border-top: 1px solid $colour_contextMenuBorder;',
    'margin: 4px 0;',
    'padding: 0;',
  '}',
