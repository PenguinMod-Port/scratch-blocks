...
Blockly.Msg.LOOKS_CHANGEVISIBILITYOFSPRITE = '%1 %2';
Blockly.Msg.LOOKS_CHANGEVISIBILITYOFSPRITE_MENU = '%1';
Blockly.Msg.LOOKS_CHANGEVISIBILITYOFSPRITESHOW = 'show %1';
Blockly.Msg.LOOKS_CHANGEVISIBILITYOFSPRITEHIDE = 'hide %1';
Blockly.Msg.LOOKS_SETFONT = 'set font to %1 with size %2';
...
Blockly.Msg.LOOKS_PREVIOUSBACKDROP = 'previous backdrop';
Blockly.Msg.LOOKS_GETOTHERSPRITEVISIBLE_MENU = '%1';
Blockly.Msg.LOOKS_GETOTHERSPRITEVISIBLE = 'is %1 visible?';
Blockly.Msg.LOOKS_STOPTALKING = 'stop speaking';
Blockly.Msg.LOOKS_GETINPUTOFCOSTUME = '%1 of %2';
Blockly.Msg.LOOKS_GETINPUT_MENU = '%1';
...
Blockly.Msg.MOTION_IFONSPRITEBOUNCE_EDGE = 'mouse-pointer';
...
Blockly.Msg.SENSING_OBJECT_TOUCHING_CLONE ="%1 touching clone of %2?";
Blockly.Msg.SENSING_OBJECT_TOUCHING_OBJECT ="%1 touching %2?";
Blockly.Msg.SENSING_KEY_HIT ="key %1 hit?";
Blockly.Msg.SENSING_MOUSE_SCROLLING ="is mouse scrolling %1?";
Blockly.Msg.SENSING_MOUSE_CLICKED ="mouse clicked?";
Blockly.Msg.SENSING_FINGER_DOWN ="finger %1 down?";
Blockly.Msg.SENSING_FINGER_TAPPED ="finger %1 tapped?";
Blockly.Msg.SENSING_FINGER_X ="finger %1 x";
Blockly.Msg.SENSING_FINGER_Y ="finger %1 y";
Blockly.Msg.SENSING_DRAGGABLE ="draggable?";
Blockly.Msg.SENSING_LOGGED_IN ="logged in?";
Blockly.Msg.SENSING_REGEX_TEST ="test regex %2 %3 with text %1";
Blockly.Msg.SENSING_IS_NUMBER ="%1 is number?";
Blockly.Msg.SENSING_HAS_TEXT ="%1 has text?";
Blockly.Msg.SENSING_HAS_NUMBER ="%1 has number?";
Blockly.Msg.SENSING_MOBILE ="mobile?";
Blockly.Msg.SENSING_IS_TEXT ="%1 is text?";
Blockly.Msg.SENSING_GET_SPRITE_WITH_ATTRIB ="get sprite with %1 set to %2";
Blockly.Msg.SENSING_DISTANCE_TO_POINTS ="distance from %1 %2 to %3 %4";
Blockly.Msg.SENSING_DIRECTION_TO_POINTS ="direction to %1 %2 from %3 %4";
Blockly.Msg.SENSING_IS_UPPERCASE ="is character %1 uppercase?";
Blockly.Msg.SENSING_OPERATING_SYSTEM ="operating system";
Blockly.Msg.SENSING_BROWSER ="browser";
Blockly.Msg.SENSING_URL ="url";
Blockly.Msg.SENSING_XY_OF_TOUCHING = "%1 of touching %2 point";
